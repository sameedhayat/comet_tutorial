...
from keras.layers import Flatten, MaxPooling1D, Dropout
...
model.add(Conv1D(filters=params['filter'], kernel_size=params['filter_size'], padding='same', activation=params['activation']))
